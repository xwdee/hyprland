...
run_command "yay -S --sudoloop --noconfirm hyprpaper" "Install hyprpaper for wallpaper management" "yes" "no"
...
run_command "yay -S --sudoloop --noconfirm hyprshot" "Install hyprshot - Screenshot tool" "yes" "no"
